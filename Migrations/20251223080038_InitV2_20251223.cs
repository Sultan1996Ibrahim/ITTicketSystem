...
{
    /// <inheritdoc />
    public partial class InitV2_20251223 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CanManageDeptTickets = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManagerDepartments", x => new { x.ManagerUserId, x.DepartmentId });
                    table.ForeignKey(
                        name: "FK_ManagerDepartments_AppUsers_ManagerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_AppUsers_AssignedUserId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tickets_Departments_FromDepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_FromDepartmentId",
                table: "Tickets",
